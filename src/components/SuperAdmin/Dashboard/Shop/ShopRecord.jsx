...
export default function ShopRecord({ shops, loading, onEdit, onDeleteSuccess, onRefresh }) {
    ...
    const ActionCellRenderer = useCallback((params) => {
        ...
        const handleDelete = async () => {
            const deletePromise = deleteShop(params.data.Shop_ID)
        ...
        const showDeleteConfirm = () => {
            setDeleteConfirm(params.data.Shop_ID)
        }
        ...
        return (
            <div className="flex items-center gap-2 h-full">
                ...
                {deleteConfirm === params.data.Shop_ID && (
                            ...
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-600">
                                        Are you sure you want to delete "{params.data.Shop_Name}"? This action cannot be undone.
                                    </p>
                                </div>
                            </div>
    ...
    }, [onEdit, onDeleteSuccess, deleteConfirm])
        ...
        return (
            <div className="flex items-center justify-center py-12">
                <div className="text-center">
                    ...
                    <p className="mt-4 text-lg font-medium text-gray-900">Loading shops...</p>
                </div>
            </div>
        )
    }
    ...
    return (
        <div className="rounded-lg bg-white shadow-sm border border-[#e8dabe] overflow-hidden">
            {/* Table Header */}
            ...
            {shops.length === 0 && !loading && (
                <div className="text-center py-12">
                    ...
                    <p className="mt-2 text-gray-600">Get started by adding your first shop.</p>
                </div>
            )}
        </div>
    )
