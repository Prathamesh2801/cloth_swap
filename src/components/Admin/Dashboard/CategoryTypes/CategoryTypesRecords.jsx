    ...
    return (
        <div className="space-y-4">
                ...
                {showFilters && (
                    ...
                    >
                        ...
                        <div>
                            ...
                            <input
                                type="text"
                                value={filters.Type_Title}
                                onChange={e => setFilters(f => ({ ...f, Type_Title: e.target.value }))}
                                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#8B7355] focus:border-transparent"
            ...
            <ConfirmModal
                ...
                message={
                    deleteConfirm
                        ? `Are you sure you want to delete type "${deleteConfirm.Type_Title}"? This action cannot be undone.`
                        : ""
                }
                confirmText="Delete"
                ...
                onConfirm={() => {
                    if (deleteConfirm) {
                        onDelete(deleteConfirm.Type_ID);
...
export default CategoryTypesRecords;
